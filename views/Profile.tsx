...
import { 
  MapPin, Link as LinkIcon, Calendar, Twitter, Linkedin, Github, 
  Award, TrendingUp, Zap, Users, CheckCircle2, ArrowUpRight, 
  Briefcase, Code2, Globe, Copy, ShieldCheck
} from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 px-4 md:px-0">
         ...
         <div className="lg:col-span-4 space-y-6">
            ...
            <Card hoverable>
               ...
               <div className="space-y-4">
                  {[{l: 'Product Strategy', v: '95%'}, {l: 'React / Next.js', v: '90%'}, {l: 'Fundraising', v: '85%'}].map(skill => (
                     <div key={skill.l}>
            ...
            <Card className="bg-gradient-to-br from-cofound-darkBg to-cofound-darkBlue text-white border-none shadow-xl">
               ...
               <div className="flex -space-x-3 mb-5 pl-2">
                  {[1,2,3,4].map(i => (
                     <div key={i} className="w-10 h-10 rounded-full border-2 border-cofound-darkBlue bg-white shadow-sm"></div>
                  ))}
         ...
         <div className="lg:col-span-8 space-y-8">
            ...
            <div>
               ...
               <div className="space-y-4">
                  {[1, 2].map((i) => (
                     <Card key={i} hoverable className="flex gap-5 !p-5">
            ...
            <div>
               ...
               <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                  {['Figma', 'React', 'TypeScript', 'Node.js', 'Postgres', 'AWS', 'Stripe', 'OpenAI'].map(tool => (
                     <div key={tool} className="flex items-center gap-3 p-3.5 rounded-xl border border-cofound-grey dark:border-white/10 bg-white dark:bg-cofound-darkCard shadow-sm hover:shadow-md hover:border-cofound-blue/30 transition-all cursor-default">
