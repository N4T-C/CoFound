    ...
    <div className="max-w-5xl mx-auto space-y-6 animate-fade-in pb-10">
       ...
       <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            ...
            <Card key={i} className="flex flex-col justify-between group cursor-pointer hover:border-cofound-blue/30 p-6">
                  ...
                  <ResponsiveContainer width="100%" height="100%">
                    <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                      ...
                      <Tooltip 
                        ...
                        itemStyle={{color: '#0D1A2D', fontSize: '14px', fontWeight: 'bold'}}
                        cursor={{stroke: '#2A6FF7', strokeWidth: 2}}
                      />
          ...
          <div className="space-y-4">
             ...
             <Card className="h-full min-h-[400px] !p-0">
                <div className="divide-y divide-cofound-grey dark:divide-white/10">
                  {[1,2,3,4,5].map((item) => (
                    <div key={item} className="p-5 hover:bg-cofound-bg/50 dark:hover:bg-white/5 transition-colors group cursor-pointer">
